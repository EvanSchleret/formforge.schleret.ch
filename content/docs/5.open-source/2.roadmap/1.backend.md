...
description: Planned and completed milestones for the FormForge backend.
---

The backend roadmap tracks work on the Laravel package and its HTTP, persistence, and operations layers.
