...
- `pagination="auto"` is the default and keeps the renderer's block navigation
- `pagination="none"` renders all visible fields on one screen and hides navigation controls
