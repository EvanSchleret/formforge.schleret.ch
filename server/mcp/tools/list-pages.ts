...
import type {} from '../../../.nuxt/content/types'
...
WHEN NOT TO USE: If you already know the specific page path (e.g., "/docs/getting-started/installation"), use get-page directly instead.
